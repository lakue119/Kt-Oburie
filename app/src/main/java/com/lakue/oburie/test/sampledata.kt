...
val testJobOffer1 = JobOffer(UserInfo(),
        arrayListOf(),
        "oo웨딩홀 축가 급구해요!!",
...
val testCategory = arrayListOf(Category(0, "서양・현악기", "", R.drawable.ic_violin), Category(0, "서양・관악기", "", R.drawable.ic_sexophone), Category(0, "서양・건반,타악기", "", R.drawable.ic_piano)
...
val testJobOffer2 = JobOffer(UserInfo(),
...
val testNewProfile = arrayListOf(Profile("PLATINUM",
        "가야금",
        "대전,서울,천안",
        4.0f, 4.0f, 4.0f, 4.0f, 38,
        arrayListOf("https://cdn.imweb.me/upload/S20170720597014723fac6/5989c7725e109.jpg"),
...
val testGroupProfile = arrayListOf(Profile("PLATINUM",
        "가야금",
        "대전,서울,천안",
        4.0f, 4.0f, 4.0f, 4.0f, 38,
