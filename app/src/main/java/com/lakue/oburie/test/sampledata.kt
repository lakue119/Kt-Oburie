...
val testChatting1 = Chatting(idx = 0,
        text = "안녕하세요",
        date = "2021-01-01",
        type = "SEND")
val testChatting2 = Chatting(idx = 0,
        text = "안녕하세요",
        date = "2021-01-01",
        type = "ANSWER",
        profileImg = "https://spnimage.edaily.co.kr/images/Photo/files/NP/S/2017/03/PS17032000004.jpg",
        profileName = "라꾸")
val testChatting21 = Chatting(idx = 1,
        text = "ㅎ",
        date = "2021-01-01",
        type = "ANSWER",
        profileImg = "https://spnimage.edaily.co.kr/images/Photo/files/NP/S/2017/03/PS17032000004.jpg",
        profileName = "라꾸")
val testChatting22 = Chatting(idx = 2,
        text = "ㅇ",
        date = "2021-01-01",
        type = "ANSWER",
        profileImg = "https://spnimage.edaily.co.kr/images/Photo/files/NP/S/2017/03/PS17032000004.jpg",
        profileName = "라꾸")
val testChatting23 = Chatting(idx = 3,
        text = "ㅃ",
        date = "2021-01-01",
        type = "ANSWER",
        profileImg = "https://spnimage.edaily.co.kr/images/Photo/files/NP/S/2017/03/PS17032000004.jpg",
        profileName = "라꾸")
val testChatting24 = Chatting(idx = 4,
        text = "ㅉㅇ",
        date = "2021-01-01",
        type = "ANSWER",
        profileImg = "https://spnimage.edaily.co.kr/images/Photo/files/NP/S/2017/03/PS17032000004.jpg",
        profileName = "라꾸")
val testChatting221 = Chatting(idx = 0,
        text = "안녕하세요",
        date = "2021-01-05",
        type = "ANSWER",
        profileImg = "https://spnimage.edaily.co.kr/images/Photo/files/NP/S/2017/03/PS17032000004.jpg",
        profileName = "라꾸")
val testChatting3 = Chatting(idx = 0,
        text = "안녕하세요",
        date = "2021-01-01",
        type = "SEND_MAP",
        ...
        state = "NORMAL")
val testChatting4 = Chatting(idx = 0,
        text = "안녕하세요",
        date = "2021-01-01",
        type = "ANSWER_MAP",
        locationTitle = "서울특별시 신대방동 632-10",
        ...
        meetingStartTime = "13시 30분",
        state = "NORMAL")
val testChatting5 = Chatting(idx = 0,
        text = "라꾸님이 확인하였습니다.",
        date = "2021-01-01",
        type = "MESSAGE")