...
//    private val profileRepository: ProfileRepository
    ...
    private val _liveJobOffer = MutableLiveData<JobOffer>(JobOffer(UserInfo(),
            arrayListOf(JobOfferBadge(0,"NEW","NEW")),
            "oo웨딩홀 축가 급구해요!!",
    ...
    val liveJobOffer: LiveData<JobOffer> = _liveJobOffer

    val jobOfferBadgeAdapter = JobOfferBadgeAdapter(liveJobOffer.value?.badge as ArrayList<JobOfferBadge>)
}